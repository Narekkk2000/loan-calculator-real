...
const baseMap: Record<ButtonVariant, string> = {
  ghost:
      'px-2.5 py-1 w-[56px] h-[24px] rounded text-[12px] transition-all font-ibm-mono',
  preset:
      'px-4.5 py-2 rounded-md text-sm transition-all duration-150 cursor-pointer font-ibm-mono',
  'card-select':
      'text-left p-2 rounded-xl transition-all duration-200 cursor-pointer',
  action:
      'flex items-center gap-2 px-4 py-2 rounded-lg text-xs font-medium transition-all duration-200 font-ibm-mono',
  toggle:
      'relative z-10 flex-1 py-1 px-3 text-md font-medium transition-colors duration-200 cursor-pointer select-none font-ibm-mono',
}
