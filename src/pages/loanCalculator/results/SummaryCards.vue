  ...
  return [
    {
      ...
      value: formatCurrency(s.totalPayment),
    ...
    },
    {
      ...
      value: formatCurrency(s.totalOverpayment),
    ...
    {
      label: paymentLabel,
      value: formatCurrency(s.firstMonthPayment),
      sub: paymentSub,
      color: COLORS.MUTED,
      icon: '▷',
    },
...
<template>
  <div class="relative flex">
    <div class="rounded-xl bg-gray-50 p-5 flex flex-col gap-4 transition-all duration-20 w-full">
      <div
        v-for="(card, index) in cards"
        :key="card.label"
        class="pb-3 border-b border-b-gray-200 last:border-b-0 last:pb-0"
      >
